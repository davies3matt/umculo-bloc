...
import { GroupType, useCreateGroupMutation, useCreateUsersGroupsMutation } from '../../generated/graphql';
                ...
                {({
                    ...
                    return (
                        ...
                        <VStack width="80%" space={4}>
                            ...
                            {console.log('errors')}
                            <Input onBlur={handleBlur('name')} placeholder="Huis Woes" onChangeText={handleChange('name')} value={values.name} />
                            </FormControl>
                            ...
                            <Select>
                                {Object.keys(GroupType).map(type => 
                                    <Select.Item key={type} label={formatEnums(type)} value={type}/>)}
                            </Select>
